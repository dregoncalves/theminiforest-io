    ...
    <div className={styles.container}>
      ...
      <ul className={styles.sitemapList}>
        <li className={styles.sitemapItem}>
          ...
          <ul>
            <li>
              <a href="#" className={styles.subCategoryTitle}>Por idade</a>
              <ul>
            ...
            <li>
              <a href="#" className={styles.subCategoryTitle}>Por tipo de peça</a>
              <ul>
            ...
            <li>
              <a className={styles.subCategoryTitle} href="https://www.theminiforest.com/roupinhas/Lisos?map=c,specificationFilter_107&O=OrderByReleaseDateDESC">Lisos</a>
              <ul>
        ...
        <li className={styles.sitemapItem}><a href="https://www.theminiforest.com/novidades" title="Novidades">Novidades</a></li>
        <li className={styles.sitemapItem}><a href="https://www.theminiforest.com/sale">Sale</a></li>
        <li className={styles.sitemapItem}><a href="https://www.theminiforest.com/estampas">Estampas</a></li>
        <li className={styles.sitemapItem}>
